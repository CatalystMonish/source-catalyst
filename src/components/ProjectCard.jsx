...
const ProjectCard = () => {
  return (
    <div className='flex flex-col px-3 py-4 w-full h-auto rounded-xl shadow-md bg-white'>
      <p className='font-semibold text-left text-lg font-poppins space-y-2'>Speech to Text</p>
      ...
      <div className='flex items-center'>
        ...
        <span className='px-2'>Intermediate</span>
      </div>
      <div className='flex items-center'>
        ...
        <span className='px-2'>Video & Document</span>
      </div>
