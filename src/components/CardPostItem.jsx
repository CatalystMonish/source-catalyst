...
import { db } from "../firebase"; // Adjust the import path to where your Firebase configuration file is.
...
function CardPostItem({
  ...
  const handleLikeClick = async () => {
    ...
    try {
      await setDoc(postDocRef, { likes: newLikesCount }, { merge: true }); // The merge option ensures other fields aren't overwritten
    } catch (error) {
